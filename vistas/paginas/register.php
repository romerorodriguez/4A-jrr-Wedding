...
<div class="d-flex justify-content-center text-center">
    <form class="p-5 bg-light" method="post">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="password" class="form-control" placeholder="Ingresa tu Contraseña" id="pwd" name="registerPassword">
            </div>
        </div>
        <br>
        <?php /*
   ...
   */
        ...
        if ($registro == "error") {
            ...
            echo '<div class="alert-danger"> Oh,no ocurrio un ERROR!! </div><br>
        <div class="alert-danger"> No se aceptan carácteres especiales</div>';
        }
        ?>
        <br>
